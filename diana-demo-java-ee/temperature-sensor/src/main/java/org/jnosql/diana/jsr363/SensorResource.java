...
public class SensorResource {
    ...
    public SensorRepresentation example() {
        ...
        representation.setQuantity(QuantityRepresentation.of(factory.create(10, Units.CELSIUS)));
        representation.setTime(LocalDate.now().toString());
    ...
    public void save(SensorRepresentation representation) {
        sensorService.save(representation.toSensor());
    }
